...
// spotless:off
/**
 * @class XForwardedProtoStub
 * @brief XForwardedProtoStub tells others that the optional HTTP header was not found
 *
 * @responsibilities
 ...
 * }
 *
 * XForwardedProtoStub --> HeaderInfo : Tell that it is a stub
 *
 * note right of XForwardedProtoStub
 * Responsibilities:
 * - Throw an exception if value is asked for
 * - Tell others that it is a stub object
 *
